        ...
        <section id="contact" className="py-48">
            ...
            <motion.div initial="hidden" 
                ...
                <div className="md:flex md:justify-between gap-16 mt-5">
                    ...
                    <motion.div className="basis-1/2 md:10 md:mt-0"
                                initial="hidden" 
                                whileInView="visible" 
                                viewport={{once: true, amount: 0.5}}
                        ...
                        <form target="_blank"
                           ...
                           <input className="w-full bg-blue font-semibold placeholder-opaque-black p-3"
                            ...
                            {
                                errors.name && (
                                   <p className="text-red mt-0">
                                     {errors.name.type === "required" && "This field is required."}
                                     {errors.name.type === "maxLength" && "Max lenth is 100 char."}
                                   </p>
                                )
                            }
                            ...
                            <button type="submit" className="p-5 bg-yellow font-semibold text-deep-blue mt-5 hover:bg-red
