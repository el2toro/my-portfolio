...
const Landing = ({setSelectedPage}: any) => {
    ...
    return (
        <section id="home" className="md:flex md:justify-between md:items-center md:h-full gap-16 py-10">
          ...
          {/* IMAGE SECTION */}
          <div className="md:order-2 flex justify-center basis-3/5 z-10 mt-10 md:mt-32">
             {isAboveLarge ? (
             ...
             <div className="z-30 basis-2/5 mt-12 md:mt-32">
                ...
                <motion.div
                    ...
                    variants={{
                        ...
                        <p className="text-6xl font-payfair z-10 text-center md:text-start">
                            Jane {""}
                           <span className="xs:relative xs:text-deep-blue xs:font-semibold z-20
                                            xs:before:content-brush before:absolute before:-left-[25px]
                                            befote:-top-[70px] before:z-[-1]">
                            Esper
                           </span>
                        </p>
