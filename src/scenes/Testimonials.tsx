...
const Testimonials = () => {
    const testimonialStyles = `mx-auto relative max-w-[400px] w-[350px] flex flex-col 
   ...
   return(
       <section id="testimonials" className="pt-32 pb-16">
         ...
         <motion.div className="md:w-1/3 text-center md:text-left" 
                    ...
                    <p className="font-payfair font-semibold text-4xl md-5 text-red">
                      TESTIMONIALS
                    </p>  
                ...
                <div className="md:flex md:justify-between gap-8">
                    ...
                    <motion.div className={`bg-red ${testimonialStyles} before:content-person2`} 
                         ...
                         <p className="font-playfair text-6xl">“</p>
                         <p className="text-center text-xl">
                            Praesent fermentum, erat ut viverra rutrum, nibh tellus sollicitudin lacus, et bibendum dui justo fringilla purus. 
                         </p>
                    </motion.div>
                    ...
                    <motion.div className={`bg-yellow ${testimonialStyles} before:content-person3`} 
                         ...
                         <p className="font-playfair text-6xl">“</p>
                         <p className="text-center text-xl">
                            Suspendisse nunc libero, maximus eget scelerisque in, pellentesque vel elit.
                         </p>
                    </motion.div>
                </div>
       </section>
